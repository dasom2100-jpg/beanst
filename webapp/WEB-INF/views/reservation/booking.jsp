...
<div class="booking-container flex" >
    ...
    <div class="booking-form w-100">
        ...
        <form id="reserveForm" action="${pageContext.request.contextPath}/reservation/booking.do" method="post">
            ...
            <button type="button" id="submitBtn" class="btn btn-primary btn-block mt-30">예약하기</button>
        </form>
    </div>
    ...
    <div class="booking-summary" >
        ...
        <p><strong>객실:</strong> <span id="summaryRoom" >선택 안 됨</span></p>
        <p><strong>일정:</strong> <span id="summaryDate">-</span> (<span id="summaryNights">0</span>박)</p>
        <p><strong>인원:</strong> 성인 <span id="summaryAdult">2</span>명, 소아 <span id="summaryChild">0</span>명</p>
        
        <hr>
        
        <div>
            <span>기본 요금</span>
            <span><span id="summaryBasePrice">0</span>원</span>
        </div>
        <div>
            <span>인원 추가금 (1인 4만원)</span>
            <span>+ <span id="summaryExtra">0</span>원</span>
        </div>
        ...
        <div>
            <p>총 결제 예상 금액</p>
            <h2><span id="summaryTotal">0</span>원</h2>
        </div>
    </div>
</div>
