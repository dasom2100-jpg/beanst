...
<nav class="mobile-nav" aria-hidden="true">
  <ul>
    <li><a href="${pageContext.request.contextPath}/main.do" class="text">HOME</a></li>
    <li><a href="${pageContext.request.contextPath}/facility/list.do" class="text">시설 안내</a></li>
    <li><a href="${pageContext.request.contextPath}/reservation/booking.do" class="text btn-reserve">예약하기</a></li>
  	<li><a href="${pageContext.request.contextPath}/faqList.do" class="text">FAQ</a></li>
	<li><a href="${pageContext.request.contextPath}/qnaList.do" class="text">1:1문의</a></li>
  </ul>
</nav>
